...
func (s *SmartContract) recordProducerTransaction(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	stageID := 1
	var producertx = ProducerTransaction{TxID: args[0], Stage: stageID, AssetID: args[0], TotalWeightShippedPerLot: args[1], BoxesShippedPerLot: args[2], DateofProduction: args[3], DateofHarvest: args[4], NameoftheFarm: args[5], ProductionMethod: args[6], FarmingCountry: args[7], SpeciesName: args[8], DispatchDate: args[9], UsebyDate: args[10]}
...
func (s *SmartContract) recordProcessorTransaction(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	stageID := 2
	var processortx = ProcessorTransaction{TxID: args[0], Stage: stageID, AssetID: args[1], ReceptionDate: args[2], DispatchDate: args[3], ProcessingMethod: args[4], CountryofProcessing: args[5], ProductForm: args[6], ProductCondition: args[7], SizeGrade: args[8], UsebyDate: args[9], ProcessorName: args[10]}
...
func (s *SmartContract) recordDistributorTransaction(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	stageID := 3
	var distributortx = DistributorTransaction{TxID: args[0], Stage: stageID, AssetID: args[1], ReceptionDate: args[2], DispatchDate: args[3], ColdStorageConditions: args[4], DistributorName: args[5]}
